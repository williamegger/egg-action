...
public class RequestContext {
    ...
    public void write(CharSequence str) {
        ...
        Render render = RenderFactory.getTextRender(str.toString());
        doRender(render);
    }
    ...
    public void writeHTML(CharSequence str) {
        ...
        Render render = RenderFactory.getHtmlRender(str.toString());
        doRender(render);
    }

    public void writeVelocity(String view) {
        if (view == null) {
            return;
        }
        Render render = RenderFactory.getVelocityRender(view);
        doRender(render);
    }

    private void doRender(Render render) {
        try {
            render.setContent(req, resp).render();
        } catch (Exception e) {
            LogKit.error(null, e);
        }
    }
